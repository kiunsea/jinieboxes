...
/**
 * TODO 네이버 애플리케이션 관리에서 '연결 끊기' 가이드를 참고하여 request 에 대한 처리를 개발해야 한다.
 * 지니박스에서 Naver 연동을 해제하기 위한 클래스
 * @author KIUNSEA
 */
@WebServlet("/naveroff")
public class NaverOffServlet extends HttpServlet {
     ...
     */
    private Logger log = LogManager.getLogger(NaverOffServlet.class);
